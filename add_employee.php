<?php
	...
	if(isset($_POST['submit'])) {
		...
		$password=mysqli_real_escape_string($con,$_POST['password']);$department_id=mysqli_real_escape_string($con,$_POST['department_id']);
				...
				<div class="card-body card-block">
					<form method="post">
						...
						<div class="form-group">
							...
							<input type="text" value="<?php echo $password; ?>" name="password" placeholder="Enter employee password" class="form-control" required>
						</div>
						<div class="form-group">
