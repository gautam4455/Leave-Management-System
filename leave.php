<?php
	...
	/*for editing leave (for employees only)*/
			 ...
			 <div class="card">
				<div class="card-body">
				   ...
				   <?php if($_SESSION['ROLE']==2) { ?>
						<h6 class="box-title-link"><a href="add_leave.php">Add Leave</a></h6>
				   <?php } ?>				   
				</div>
				<div class="card-body--">
							...
							<tr>
								...
								<td>
									...
									if($_SESSION['ROLE']!=1) {
										if($row['leave_status']==1) {
									?>
										<a href="add_leave.php?id=<?php echo $row['id']; ?>&type=edit">Edit</a>
